...
local PlayerDataManager = pcall(function() return require(script.Parent.PlayerDataManager) end) and require(script.Parent.PlayerDataManager) or nil
local EconomyManager = pcall(function() return require(script.Parent.EconomyManager) end) and require(script.Parent.EconomyManager) or nil
local ShopConfig = pcall(function() return require(ReplicatedStorage:WaitForChild("Shared", 1):WaitForChild("Config", 1):WaitForChild("ShopConfig", 1)) end) and require(ReplicatedStorage.Shared.Config.ShopConfig) or nil
local ShopEvents = pcall(function() return require(ReplicatedStorage:WaitForChild("Shared", 1):WaitForChild("Events", 1):WaitForChild("ShopEvents", 1)) end) and require(ReplicatedStorage.Shared.Events.ShopEvents) or nil
local EconomyEvents = pcall(function() return require(ReplicatedStorage:WaitForChild("Shared", 1):WaitForChild("Events", 1):WaitForChild("EconomyEvents", 1)) end) and require(ReplicatedStorage.Shared.Events.EconomyEvents) or nil
