...
local stardustLoops: { [Player]: RBXScriptConnection? } = {}
...
local function startStardustLoop(player: Player)
	-- TODO: create a loop that awards Stardust every GameConfig.StardustIntervalSeconds
	-- Stop any existing loop
	if stardustLoops[player] then
		stardustLoops[player]:Disconnect()
	end
